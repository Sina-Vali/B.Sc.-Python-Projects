...
new_directory = r"C:\Users\Afra\Documents\VsCode\Flappy Bird"
...
class Bird:
    ...
    def draw(self, win):
        ...
        # rotating the bird around center
...
def eval_genomes(genomes, config):
    ...
    while run:
        ...
        for x, bird in enumerate(birds):
            # remove the bird when it hits the ground or gets over the screen
